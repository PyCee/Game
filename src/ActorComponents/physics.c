...
(Physics_t *physics)
{
	...
	glBegin(GL_POLYGON);
 		glVertex2f(physics->Pos->X / physics->Pos->Z, physics->Pos->Y / physics->Pos->Z);
 		glVertex2f((physics->Pos->X + physics->Width) / physics->Pos->Z, physics->Pos->Y / physics->Pos->Z);
 		glVertex2f((physics->Pos->X + physics->Width) / physics->Pos->Z, (physics->Pos->Y + physics->Height) / physics->Pos->Z);
 		glVertex2f(physics->Pos->X / physics->Pos->Z, (physics->Pos->Y + physics->Height) / physics->Pos->Z);
	glEnd();
}
